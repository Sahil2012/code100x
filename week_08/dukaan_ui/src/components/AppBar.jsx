      ...
      <div className="grow flex justify-start items-center">
        ...
        <div className="flex items-center text-xs justify-between">
          <div className="mr-1">
            ...
            >
              <g clip-path="url(#clip0_112743_2562)">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <defs>
                <clipPath id="clip0_112743_2562">
                  <rect width="14" height="14" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <div className="text-grey-500">How it works</div>
        </div>
      </div>
      <div className="grow flex justify-center">
        <div className="grow text-grey-500  flex items-center bg-grey-700 px-2 rounded-lg">
          <div className="mr-1">
            <svg
              width="16"
              height="16"
          ...
          <input className="bg-inherit items-center text-sm grow focus:outline-none" type="text" placeholder="Search features, tutorial, etc."/>
        </div>
      </div>
      <div className="grow flex justify-end">
        <div>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_112743_2572)">
        ...
        <div>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_112743_2577)">
              <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
              <path
